# Report On PROkka
This repository contains the scripts for generating a report on [Prokka](https://github.com/tseemann/prokka) data. This tool is to be used for gathering and reporting data, not for evaluating the results.
